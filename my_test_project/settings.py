...
SECRET_KEY = 'django-insecure-og!wvsix19#abln(n!r^&eo4gc4*0s79)5b_07ubcuivw!b%!7'
...
# LOGIN_REDIRECT_URL = '/home/'  # Redirect users to dashboard after login
...
# ✅ Django will now use UserProfile instead of default User
AUTH_USER_MODEL = 'my_home.UserProfile'
...
CORS_ALLOWED_ORIGINS = [
    "http://127.0.0.1:5500",  # ✅ If using Live Server (VS Code)
     "http://localhost:5500",  # ✅ Allow frontend (Localhost)
    "http://127.0.0.1:8000",  # ✅ Django API server
]
